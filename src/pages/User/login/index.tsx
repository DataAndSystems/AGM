...
import {setLocalUserInfo} from '@/services/hmdp/user';
    ...
    try {
      ...
      if (msg?.success) {
        ...
        let userInfo = {
          ...
          token: msg.data.access_token,
          roles: msg.data.role_list
        }
      ...
      <div className={styles.content}>
        <div className={styles.top}>
          <div className={styles.header}>
            <Link to="/">
              <img alt="logo" className={styles.logo} src="/logo-normal.png" />
              <span className={styles.title}>惠每数据平台</span>
            </Link>
          </div>
        </div>
